...
public class OldHelpActivity extends Activity implements EventListener, LocationListener{
	private static final Logger logger = LoggerFactory.getLogger(OldHelpActivity.class);
    ...
    private void setupPreview() throws IOException{
        ...
        FrameLayout previewFrame = (FrameLayout) findViewById(R.id.root);
